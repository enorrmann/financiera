...
import ar.com.norrmann.financiera.web.converter.PagoConverter;
...
privileged aspect PagoConverter_Roo_Converter {
    ...
    declare @type: PagoConverter: @FacesConverter("ar.com.norrmann.financiera.web.converter.PagoConverter");
